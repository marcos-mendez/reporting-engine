...
.. code:: pip3 install git+https://gitlab.com/nicoclavier/py3o.renderers.juno.git, 

This is what creates the JavaServer that randers the Adobe transformation PDF files.
